...
/*function confirmDialog(text, callback) {
	var popupDialogId = 'confirmRestartDialog';
	$('<div data-role="popup" id="' + popupDialogId + '" data-confirmed="no" data-transition="pop" data-overlay-theme="b" data-theme="b" data-dismissible="false" style="max-width:500px;">' + 
	        ...
	        '<div role="main" class="ui-content" align="center" style="background-color: white;">' + 
	        	'<h3 style="color:black;margin-bottom: 55px;font-weight: normal;" class="ui-title">' + text + '</h3>' + 
        		'<div class="ui-grid-a ui-responsive" id="button-div">' + 
					'<div class="ui-block-a">' + 
        				'<a href="#" class="btn-submit optionConfirm" data-rel="back" style="color:#DF4B20;font-weight:normal;text-decoration: none;">Yes</a>' +
					'</div>' +
					'<div class="ui-block-b">' + 
						'<a href="#" class="btn-back optionCancel" data-rel="back" data-transition="flow" style="color:#DF4B20;font-weight:normal;text-decoration: none;">No</a>' +
					'</div>' + 
				'</div>' +
			'</div>' +
		'</div>'
