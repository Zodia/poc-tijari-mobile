	...
	$(
			'<div data-role="popup" id="'
					...
					+ '<div class="ui-grid-a ui-responsive" id="button-div">'
						+'<div class="ui-block-a"><a href="#" id="btn-back" class=" optionConfirm" data-rel="back">Yes</a></div>'
						+'<div class="ui-block-b"><a href="#" id="btn-submit" class="btn-submit optionCancel" data-rel="back" data-transition="flow" >No</a></div>'
					+'</div>'
	                +'</div>')
