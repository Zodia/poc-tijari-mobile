...
$("#loanAmountField").text(terms.amount);
$("#interest").text(terms.interest);
$("#duration").text(terms.duration);
 ...
 */
function loan() {
	var cn = document.getElementById("refinanceSimulator").getElementsByTagName(
			"input");
